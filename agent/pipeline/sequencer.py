...
_SEQUENCER_PROMPT = (
    ...
    "discovery step's report always reaches the final answer regardless — {{{{step_k}}}} is only "
    "needed when a later step must consume that report directly before it runs. "
